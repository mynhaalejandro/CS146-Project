...
public class MyDataBaseHelperEnglish extends SQLiteOpenHelper {

    // Database name
    public static String DATABASE_QUESTION = "questionBanks.db";
    // Current version of database
    private static final int DATABASE_VERSION = 1;
    // Database table name
    private static final String TABLE_QUESTION = "QuestionBanks";
    ...
    public MyDataBaseHelperEnglish(Context context) {
