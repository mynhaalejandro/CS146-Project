...
public class HighestScoreEnglish extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_highest_score_english);
    ...
    public void onRepeatClick(View view) {
        Intent intent = new Intent(HighestScoreEnglish.this, MainActivity.class);
