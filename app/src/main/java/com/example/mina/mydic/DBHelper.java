...
public class DBHelper extends SQLiteOpenHelper {
    ...
    private final String TBL_ENG_ILO = "eng_ilo";
    private final String TBL_ILO_ENG = "ilo_eng";
    ...
    public String getTableName(int dicType) {
        String tableName = "";
        if (dicType == R.id.action_ilo_eng) {
            tableName = TBL_ILO_ENG;
        } else if (dicType == R.id.action_eng_ilo) {
            tableName = TBL_ENG_ILO;
        }
        return tableName;
    }
